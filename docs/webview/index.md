...
创建项目完成后，我们需要创建 webview ，并打开我们的Web应用，这里以 ZEGOCLOUD Web CallKits 为例, 根据是否需要白板上传图片功能，下面的步骤1和2 您只需要关注一个就可以；

1. 复制以下代码到项目的 MainActivity.kt 文件中 （不需要白板上传图片功能）
   ...
   ```
2. 复制以下代码到项目的 MainActivity.kt 文件中（需要白板上传图片功能）
...
1. 修改viewController.swift 如下
   ...
   class ViewController: UIViewController, WKUIDelegate {
       ...
       override func viewDidLoad() {
           super.viewDidLoad()
           let request = URLRequest(url: URL(string: "https://zegocloud.github.io/zego_uikit_prebuilt_web/video_conference/index.html")!)
